...
/* #pragma acc data copyin(ham_old, s_g_old, gp1[0:GRIDPOINTS], gp2[0:GRIDPOINTS], g_X[0:GRIDPOINTS],gauge1[0:GRIDPOINTS], gauge1_old[0:GRIDPOINTS], gauge2[0:GRIDPOINTS], gauge2_old[0:GRIDPOINTS], g_fermion[0:GRIDPOINTS], link1[0:GRIDPOINTS], link2[0:GRIDPOINTS]) */
#pragma acc data copyin(gauge1[0:GRIDPOINTS], gauge1_old[0:GRIDPOINTS], gauge2[0:GRIDPOINTS], gauge2_old[0:GRIDPOINTS], link1[0:GRIDPOINTS], link2[0:GRIDPOINTS]) copyout(gauge1, gauge2, link1, link2), create(gp1, gp2) 
...
/* #pragma acc update host(gauge1, gauge2) */
      printf("\t Step %04i,\t mp = %2.4lf,\t dh = %2.4lf\n", i, mean_plaquette(), ham-ham_old);
  ...
  rlxd_init(2, 123456);
#pragma acc data copyin(gp1[0:GRIDPOINTS], gp2[0:GRIDPOINTS], gauge1[0:GRIDPOINTS], gauge1_old[0:GRIDPOINTS], gauge2[0:GRIDPOINTS], gauge2_old[0:GRIDPOINTS], link1[0:GRIDPOINTS], link2[0:GRIDPOINTS])
...
#pragma acc data copyin(gp1[0:GRIDPOINTS], gp2[0:GRIDPOINTS], gauge1[0:GRIDPOINTS], gauge1_old[0:GRIDPOINTS], gauge2[0:GRIDPOINTS], gauge2_old[0:GRIDPOINTS], link1[0:GRIDPOINTS], link2[0:GRIDPOINTS])
  for(i = 0; i < g_measurements; i ++)
  {
    ...
    printf("\t Step %04i,\t mp = %2.8lf,\t tc = %2.1lf,\t dh = %2.8lf,\t acc = %d\n", i, mp, tc, -dh, accepted_cur);
